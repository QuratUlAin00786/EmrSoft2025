        ...
        if (auth.isPatient) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('This app is for patients only. Please use the Doctor app.'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text('Email: patient@cura.com'),
                      const Text('Password: patient123'),
                      const SizedBox(height: 8),
                      TextButton(
                        onPressed: () {
                          _emailController.text = 'patient@cura.com';
