...
class ApiService {
  ...
  static Future<List<dynamic>> getAppointments([String? filter]) async {
    final endpoint = filter != null ? '/api/appointments?$filter' : '/api/appointments';
  ...
  static Future<List<dynamic>> getMedicalRecords([int? patientId]) async {
    final endpoint = patientId != null ? '/api/medical-records?patientId=$patientId' : '/api/medical-records';
    final response = await get(endpoint);
    return response is List ? response : [response];
  }
  ...
  static Future<Map<String, dynamic>> updateMedicalRecord(int id, Map<String, dynamic> data) async {
    return await put('/api/medical-records/$id', data);
  }
  ...
  static Future<Map<String, dynamic>> updateLabResult(int id, Map<String, dynamic> data) async {
    return await put('/api/lab-results/$id', data);
  }
  ...
  static Future<Map<String, dynamic>> updatePrescription(int id, Map<String, dynamic> data) async {
    return await put('/api/prescriptions/$id', data);
  }

  // Medical staff endpoints
  static Future<List<dynamic>> getMedicalStaff() async {
    final response = await get('/api/medical-staff');
    return response is List ? response : [response];
  }
  ...
  static Future<List<dynamic>> getDoctorsBySpecialty(String specialty) async {
    final response = await get('/api/medical-staff/doctors?specialty=$specialty');
    return response is List ? response : [response];
  }

  static Future<List<dynamic>> searchDoctors(String query) async {
    final response = await get('/api/medical-staff/search?q=$query');
    return response is List ? response : [response];
  }

  static Future<Map<String, dynamic>> getDoctorSchedule(int doctorId, String date) async {
    return await get('/api/medical-staff/$doctorId/schedule?date=$date');
  }
}
