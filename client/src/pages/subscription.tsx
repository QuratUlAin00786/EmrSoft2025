                  ...
                  <CardContent>
                    ...
                    <Button
                      className={`w-full mt-6 ${
                        plan.popular ? "bg-medical-blue hover:bg-blue-700" : ""
                      }`}
          ...
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-neutral-600 dark:text-gray-400 max-w-2xl mx-auto">
                Enhance your EMR system with specialized packages designed for
                modern healthcare practices. Mix and match to create the perfect
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {packages.map((pkg) => {
                ...
                return (
                  <Card
                    key={pkg.id}
                    className="relative hover:shadow-lg transition-shadow border border-neutral-200 dark:border-slate-600"
                  >
            ...
            <div className="mt-12">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">
                  Popular Package Bundles
                </h3>
                <p className="text-neutral-600 dark:text-gray-400 max-w-2xl mx-auto">
                  Save money with our curated package bundles designed for
                ...
                <Card className="border-2 border-medical-blue/20 bg-medical-blue/5 dark:bg-medical-blue/10">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600 dark:text-gray-400 mt-1">
                          Perfect for family practices and general medicine
                        </p>
                      </div>
                    ...
                    <div className="flex items-center space-x-2 mt-3">
                      ...
                      <span className="text-lg text-neutral-500 dark:text-gray-400 line-through">
                        £87
                      </span>
                      <span className="text-sm text-neutral-500 dark:text-gray-400">
                        /month
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600 dark:text-gray-400 mt-1">
                          Advanced tools for specialized medical practices
                        </p>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center space-x-2 text-sm">
                        <Check className="h-4 w-4 text-green-500" />
                        <span className="text-gray-700 dark:text-gray-300">
                          Multi-Specialty Tools (£30)
                        </span>
                      </div>
                      <div className="flex items-center space-x-2 text-sm">
                        <Check className="h-4 w-4 text-green-500" />
                        <span className="text-gray-700 dark:text-gray-300">
                          HIPAA Security Plus (£22)
                        </span>
                      </div>
                    </div>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-sm text-neutral-500 dark:text-gray-500 mt-2">
                  Billing records will appear here once your subscription
                  becomes active.
                </p>
              </div>
            </CardContent>
