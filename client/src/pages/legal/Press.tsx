...
export default function Press() {
  const pressReleases = [
    ...
    {
      id: 2,
      title: "Halo Group Expands Healthcare Technology Portfolio with Cura EMR",
      date: "8th December 2024",
      summary: "Strategic investment in healthcare technology demonstrates Halo Group's commitment to transforming medical practice management.",
