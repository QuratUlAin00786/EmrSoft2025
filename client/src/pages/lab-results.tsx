  ...
  const saveSignature = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Update the lab results queries to refresh data
        queryClient.invalidateQueries({ queryKey: ["/api/lab-results"] });
        ...
        toast({
          title: "Success",
          description:
            "Lab result has been electronically signed and saved to database",
        });
      } else {
            ...
            >
              ...
              <div className="text-center border-b pb-4">
                ...
                <div className="text-sm text-gray-700 mt-2">
                  <p className="font-semibold">Provider: <span className="font-normal">undefined</span></p>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm text-blue-800">
                    ...
                    <div>
                      <p>
                        ...
                        {selectedResult.doctorName || "Provider undefined"}
                      </p>
                      <p>
                        <strong>Diagnosis:</strong> {selectedResult.testType}
                      </p>
                      <p>
                        <strong>Total Test Results:</strong>{" "}
                        {selectedResult.results?.length || 0}
                      </p>
                    </div>
                  </div>
                  <div className="mt-3 p-3 bg-white rounded border">
                    ...
                    <div className="text-xs text-gray-600 mb-1">
                      • {selectedResult.testType} (Test ID: {selectedResult.testId})
                    </div>
                  </div>
                </div>
              )}
