  ...
  useEffect(() => {
    const loadPayPalSDK = async () => {
      try {
        ...
        script.src = 'https://www.paypal.com/sdk/js?client-id=AWRf8CRCgtiSSITXP2nPD9SE_FhpOluoD3SyGj3CJcwl_K8xHjc5c_lxzRpg4cRbZwd7wkN06LwiVPg9&currency=GBP&intent=capture';
        script.async = true;
