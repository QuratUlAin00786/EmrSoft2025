    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              widget.patientName ?? 'Video Consultation',
        ...
        children: [
          ...
          Text(
            widget.patientName != null
                ? 'Tap the call button to connect with ${widget.patientName}'
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Camera sharing started')),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Document sharing feature coming soon')),
                );
              },
            ),
          ],
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              'Would you like to add consultation notes?',
